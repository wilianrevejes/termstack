...
# pwsh analogue of zsh/zshrc, minus everything Unix-only (oh-my-zsh,
# powerlevel10k, the mise activation): on native Windows the tools come from
# winget and are already on PATH.
